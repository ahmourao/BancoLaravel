...
<body class="container mt-5">
    ...
    <a href="{{ route('formularioConta') }}" class="btn btn-secondary mb-3">Cadastrar Conta</a>
    <a href="{{ route('listaClientesContaCorrente') }}" class="btn btn-dark mb-3">Painel de Contas</a>
